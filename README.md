...
You can run a hosted version of the app at [myreads-pierratono.surge.sh/](https://myreads-pierratono.surge.sh/)
...
```
git clone https://github.com/pierratono/MyReads.git
npm install
```
...
_This project is licensed under the terms of the ISC license._
